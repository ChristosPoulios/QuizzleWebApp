...
<body>
	...
	<div class="tab-container">
		<div class="tabs">
			<a href="index" class="tab">Home</a> <a href="theme"
				class="tab active">Quizthemen</a> <a href="question" class="tab">Quizfragen</a>
			<a href="quiz" class="tab">Quiz</a> <a href="statistics" class="tab">Statistik</a>
		</div>
	</div>

	<form id="exam-form" method="post" action="theme" novalidate>
		...
		<div class="container">
			...
			<div id="themen">
				<label>Themen</label> <select id="themen-liste" size="10"
					name="themen-liste"
					onchange="document.getElementById('actionInput').value='autoload'; this.form.submit();">
					<%
		...
		<div class="buttons">
			<button type="submit"
				onclick="document.getElementById('actionInput').value='delete'">Thema
				löschen</button>
			<button type="submit"
				onclick="document.getElementById('actionInput').value='save'">Thema
				speichern</button>
			<button type="submit"
				onclick="document.getElementById('actionInput').value='new'">Neues
				Thema</button>
		</div>
	</form>
</body>
